package com.mulesoft.connectors.helloworld.internal.connection.provider.base;
...
import com.mulesoft.connectors.helloworld.api.proxy.HttpProxyConfig;
 ...
 */
public class UnsecuredConnectionProviderBase extends BaseConnectionProvider
  ...
  @Parameter
  @Optional(defaultValue = "http://localhost:8000/v1/search")
