package com.mulesoft.connectors.helloworld.internal.operation.base;
...
public abstract class GetGreetingOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/greeting";
  ...
  public GetGreetingOperationBase() {
    super();
  }

  public GetGreetingOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }
  ...
  protected void getGreeting(
    ...
    try {
      ...
      getGreetingMain(config, connection, customParameterBindings, parameters, overrides, callback);
  ...
  protected void getGreetingMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    doRequest(
        ...
        parameterBindings,
        customParameterBindings,
        nullOnNotFoundErrorCompletionCallbackAdapter(callback));
  }
